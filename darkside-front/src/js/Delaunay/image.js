...
export var ny = getWindowHeight();
export var nx = getWindowWidth();
...
export var container = document.getElementById('buildImage');
console.log('contenue: '+container.value);
export var clickPosition = [imageWidth * 0.5, imageHeight * 0.5];
...
export function buildImage() {
  ...
  var urls = [
      'http://www.4usky.com/data/out/80/164720338-saw-wallpapers.jpg',
...
ny=getWindowHeight();
nx=getWindowWidth();
var taille = document.getElementById("buildImage");
var hauteur = ny-50;
