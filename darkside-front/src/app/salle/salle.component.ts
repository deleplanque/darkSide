...
export class SalleComponent implements OnInit {
  ...
  imgUrl = '../assets/images/background_saw.jpg';

  ngOnInit() {
    $('html').css('background-image', 'url(' + this.imgUrl + ')');
  ...
  styles = 'Depuis aussi loin qu\'il puisse s \'en souvenir "Dr Zabor", comme il aime se faire appeler, déteste les humains. ' +
